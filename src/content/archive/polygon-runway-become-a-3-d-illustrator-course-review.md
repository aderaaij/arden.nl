...
description: "A review of Polygon Runway's flagship Blender course: what you learn, what it costs, and whether it's worth the pretty penny."
date: 2021-06-07
---

Web development is great, but adding the Z-axis to the mix gives it a whole new dimension!

Many people in my bubble have gotten the 3d spark by [Bruno Simon's ThreeJS course](https://threejs-journey.xyz/) ([which I've recently reviewed](/posts/a-3-d-journey-with-threejs-journey-xyz/)), an extensive course for the go-to 3d library on the web, ThreeJS. This course also includes an extensive lesson regarding Blender, a freely available 3d software suite with endless possibilities.
...
![A 3d cyberpunk Waterfront Scene](./images/polygon-waterfront-scene.png)

<figcaption>A Cyberpunk Waterfront Scene made by Polygon Runway</figcaption>
</figure>
...
![Screenshot from the course overview](./images/polygon-course-overview.png)

<figcaption>Screenshot from the course overview</figcaption>
</figure>
...
<figcaption>Applying the animation bonus lessons to one of the scenes got me this result! I made this!</figcaption>
</figure>
...
![A collection of 3d assets (vehicles)](./images/polygon-bonus-assets.png)

<figcaption>Some of the bonus assets provided with the course</figcaption>
</figure>
...
![An isometric 3d office scene](./images/polygon-office-scene.png)

<figcaption>Office Scene, also made by yours truly with the guiding hand of Polygon Runway!</figcaption>
</figure>
